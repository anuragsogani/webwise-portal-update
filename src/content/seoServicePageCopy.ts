...
export const SEO_PAGE_SEO = {
  ...
  description:
    "AiRAT delivers engineering-led technical SEO: Core Web Vitals, JavaScript rendering, structured data, and crawlability  -  built for enterprises where organic visibility is a revenue line.",
} as const;
...
export const SEO_SERVICES = {
  ...
  items: [
    ...
    },
    {
      ...
      body: "Hreflang implementation, multilingual URL architecture, and geo-targeting configuration for enterprises operating across UAE, India, Europe, and the US.",
    },
  ],
} as const;
